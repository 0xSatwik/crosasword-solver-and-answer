...
export default function NytMiniSolverClient() {
    ...
    const softwareSchema = {
        ...
        "@type": "WebApplication",
        "name": "NYT Mini Crossword Solver",
        "url": "https://crossword-solver.io/nyt-mini-solver",
        "description": "A free online tool to search and solve New York Times Mini Crossword clues.",
